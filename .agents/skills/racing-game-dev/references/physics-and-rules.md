...
- 底盘：`Box(0.95, 0.36, 2.05)` 下偏 0.08m，质量 **750**，线性阻尼 0.12、角阻尼 0.7（低重心、高离地，抗飞起）。
...
- 控制：`throttle` 施加于后轮（±7500N，正向取反，0-100km/h 约 1.5s），`brake` 施加四轮（≤55），转向最大 0.65rad、按住按 7/s 打角、松键按 3/s 缓慢回中。
