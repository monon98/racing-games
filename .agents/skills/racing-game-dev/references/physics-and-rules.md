...
- 底盘：`Box(0.95, 0.36, 2.05)`，质量 550，线性阻尼 0.25、角阻尼 0.3（低重心、高离地，防刹车点头前翻）。
...
- 控制：`throttle` 施加于后轮（±3200N，正向取反），`brake` 施加四轮（≤170），转向最大 0.55rad、按 6/s 平滑。
- 倒车限制：加速力 ×0.35，最高倒车速度 8 m/s；松油门且不踩刹车时施加 60N 发动机制动。
